...
//		}
	...
	public List<FollowUpDataModel> findLatestFollowUp(FollowUpType followUpType){
		   ...
		   /*
		   String sql = QueryConstants.INTERNAL_FOLLOWUP;
	   ...
	   */
		...
		try {
//			dateSample = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ").parse("2017-11-25T20:41:00.629Z");
			dateSample = new SimpleDateFormat("yyyy-MM-dd").parse("2017-11-25");
